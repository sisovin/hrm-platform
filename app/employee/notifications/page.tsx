...
export default function EmployeeNotificationsPage() {
  const [notifications, setNotifications] = useState<Notification[]>([
    ...
    },
    {
      ...
      message: "Your November payslip is now available for download",
      type: "info",
    ...
    },
    {
      ...
      message: "Don't forget to check in when you arrive at the office",
      type: "warning",
    ...
    },
    {
      ...
      message: "New cybersecurity training module is available",
      type: "info",
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Stay updated with your personal alerts and updates
          </p>
        </div>
