...
export default function AdminNotificationsPage() {
  const [notifications, setNotifications] = useState<Notification[]>([
    ...
    },
    {
      ...
      message: "November payroll has been successfully processed",
      type: "success",
    ...
    },
    {
      ...
      message: "Alice Johnson has completed onboarding process",
      type: "success",
      timestamp: "1 day ago",
      read: true,
    },
    {
      ...
      message: "Multiple late arrivals detected in Engineering department",
      type: "warning",
